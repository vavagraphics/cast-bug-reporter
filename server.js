...
// The manifest is generated by scripts/scan-cast-components.mjs and committed to
// the repo. This endpoint returns the manifest plus a status overlay that flips
// components with open (non-Resolved) Airtable bug records to status="Bug".
